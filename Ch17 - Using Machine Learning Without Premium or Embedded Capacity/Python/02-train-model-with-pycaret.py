...
save_model(best_model, r'C:\<your-path>\Ch17 - Using Machine Learning Without Premium or Embedded Capacity\Python\titanic-model')
...
# %%
df_test.to_csv(os.path.join(main_path, 'titanic-test.csv'),
               index=False)
