...
def anonymizeEmail(text_to_anonymize): 
    if text_to_anonymize != "nan" and len(text_to_anonymize) != 0 and not text_to_anonymize.isspace():
        ...
        output_text = anonymized_results.text
    elif text_to_anonymize == "nan":
        output_text = np.NaN
    else:
        output_text = text_to_anonymize
...
# import pandas as pd
# dataset = pd.read_excel(r'D:\<your-path>\Ch07 - Anonymizing and Pseudonymizing Your Data in Power BI\CustomersCreditCardAttempts.xlsx', engine='openpyxl')
