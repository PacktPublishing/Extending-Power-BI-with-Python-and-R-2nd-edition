...
circular_grouped_barplot <- function(data, grp_col_name, label_col_name,
                                     value_col_name, text_hjust=NULL) {
...
# # Uncomment if you're not running this code in Power BI
# library(readr)
