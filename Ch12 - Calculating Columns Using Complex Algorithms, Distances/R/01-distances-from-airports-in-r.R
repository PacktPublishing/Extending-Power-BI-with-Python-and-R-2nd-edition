...
hotels_tbl <- read_xlsx(r'{D:\<your-path>\Ch12 - Calculating Columns Using Complex Algorithms, Distances\hotels-ny.xlsx}')
hotels_tbl

airports_tbl <- read_csv(r'{D:\<your-path>\Ch12 - Calculating Columns Using Complex Algorithms, Distances\airport-codes.csv}')
airports_tbl
